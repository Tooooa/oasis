...
# Configuration
REDDIT_RESULTS = Path(r"D:\_Development\Agentguide\OASIS\oasis\examples\reddit_watermark_experiment\evaluation_results.json")
TWITTER_RESULTS = Path(r"D:\_Development\Agentguide\OASIS\oasis\outputs\twitter_exp\20260101_152409\evaluation_results.json")
OUTPUT_FILE = Path(r"D:\_Development\Agentguide\OASIS\oasis\outputs\combined_radar_chart.png")
# OUTPUT_FILE = Path(r"D:\_Development\Agentguide\OASIS\oasis\outputs\combined_radar_chart_original.png")
